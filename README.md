...
- Interactive 3D selection, crosshairs, tooltips, sculpting, flatten/smooth-between-points tools, and focused workspaces cropped from a rectangular 2D selection.
